    ...
    (() => {
        ...
        class SelectConstructor {
            ...
            selectInit(originalSelect, index) {
                ...
                originalSelect.dataset.speed = originalSelect.dataset.speed ? originalSelect.dataset.speed : "50";
        ...
        function rangeInit() {
            const priceSlider = document.querySelector("#rangePrice");
            if (priceSlider) {
        ...
        function initSliders() {
            if (document.querySelector(".firstscreen__slider")) {
                new core(".firstscreen__slider", {
                    modules: [ Navigation, Pagination ],
                    navigation: {
                        prevEl: ".firstscreen__arrow_prev",
                        nextEl: ".firstscreen__arrow_next"
                    },
                    pagination: {
                        el: ".firstscreen__bullets",
                        type: "bullets"
                    },
                    autoHeight: true,
                    slidesPerView: 1,
            ...
            if (document.querySelector(".authors__slider")) if (document.documentElement.clientWidth <= 479.98) {
                new core(".authors__slider", {
                    modules: [ Navigation, Pagination ],
                    navigation: {
                        prevEl: ".authors__arrow_prev",
                        nextEl: ".authors__arrow_next"
                    },
                    pagination: {
                        el: ".authors__bullets",
                        type: "bullets",
            ...
            if (document.querySelector(".slider-simillar")) {
                new core(".slider-simillar", {
                    modules: [ Navigation ],
                    clickable: true,
                    breakpoints: {
                        320: {
            ...
            if (document.querySelector(".slider-new")) {
                new core(".slider-new", {
                    modules: [ Navigation ],
                    clickable: true,
                    breakpoints: {
            ...
            if (document.querySelector(".product__sliders")) {
                const thubmsProduct = new core(".thumbs-slider-product", {
                    modules: [ Navigation ],
                    clickable: true,
                    breakpoints: {
                        320: {
                    ...
                    navigation: {
                        prevEl: ".thumbs-slider-product__arrow-prev",
                        nextEl: ".thumbs-slider-product__arrow-next"
                    }
                });
